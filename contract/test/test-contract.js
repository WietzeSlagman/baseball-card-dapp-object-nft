...
test('zoe - sell baseball cards, normal case', async (t) => {
  ...
  const bobCardAmount = makeCardMath([
    { url: 'https://agoric.com', name: 'Sleve McDichael' },
  ]);
  ...
  t.deepEqual(
    carolObtained,
    makeCardMath([{ url: 'https://agoric.com', name: 'Sleve McDichael' }]),
  ...
  t.deepEqual(
    inventoryRemaining,
    makeCardMath([{ url: 'https://agoric.com', name: 'Onson Sweemey' }]),
  );
});
